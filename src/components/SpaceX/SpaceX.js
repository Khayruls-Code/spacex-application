      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {
          ...
          >
            ...
            <div className='p-4 relative'>
              <p className={singleData?.launch_success ? "bg-green absolute -top-3 right-0 px-3 text-md font-medium text-white rounded-full w-fit shadow-lg mr-2" : "bg-red absolute -top-3 right-0 px-3 text-md font-medium text-white rounded-full w-fit shadow-lg mr-2"}>{singleData?.launch_success ? "Success" : 'Failure'}</p>
              ...
              <div className='flex items-center'>
                ...
                <a target='_blank' rel="noreferrer" className='bg-white mr-3 mt-4 w-10 h-10 rounded-full text-lg text-black flex items-center justify-center hover:scale-110 transition-transform duration-200' href={singleData?.links?.article_link}><AiOutlineLink /></a>
